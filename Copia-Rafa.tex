...
recorded sessions, of which six satisfied predefined
...
six includable sessions exhibited higher $\theta_{Fz}/\alpha_{Pz}$
ratios during high demand, with group means increasing from 1.37
($SD = 1.80$) to 4.65 ($SD = 4.99$) and a paired Cohen's
$d = 0.75$, indicating a medium effect size. In the ecological
paradigm, 6 of 8 sessions showed baseline-normalized ratios above
unity, suggesting sensitivity to task engagement under naturalistic
interaction variability. Subjective workload assessed via NASA-TLX
indicated moderate perceived demand across both paradigms. Overall,
the $\theta_{Fz}/\alpha_{Pz}$ ratio demonstrates discriminative
...
frontal theta activity (4--7~Hz) have been linked to executive
...
\cite{CavanaghFrank2014_FrontalTheta}. In contrast, task-related
alpha desynchronization---often prominent over posterior and
parietal regions---reflects increased cortical engagement and
active information processing due to a release of functional
inhibition \cite{Klimesch2007_AlphaInhibitionTiming}. These
complementary oscillatory dynamics provide a neurophysiological
basis for constructing compact spectral indices capable of
capturing variations in cognitive load.
...
attentional demands \cite{c5,c9}. While these paradigms provide
well-defined conditions for validating workload indices, many
real-world human--machine systems operate in interactive
environments where cognitive demand fluctuates dynamically and
cannot be reduced to strictly scripted stimuli. Recent
neuroergonomics studies demonstrate that EEG-based workload
...
the theta (4--7~Hz) and alpha (8--12~Hz) frequency ranges.
...
demands \cite{c1,c4,c5,c9}. The observed group-level effect size
($d = 0.75$) falls within the medium-to-large range reported by
Chikhi et al. \cite{c4} in their meta-analysis of EEG spectral
workload measures, where paired effect sizes for theta and alpha
band manipulations typically ranged from $d = 0.5$ to $d = 1.2$
across paradigms. Although the present sample is smaller than
those in confirmatory studies, the directional consistency across
all six includable sessions and the magnitude of the effect size
suggest that the index captures meaningful cognitive demand
variation under controlled conditions. The absolute CLI values
observed here (Low: 1.37, High: 4.65) are also consistent with
the theta/alpha ratio ranges reported by Raufi and Longo
\cite{c1} under moderate-to-high cognitive load conditions,
providing further convergent support for the index.
...
used for within-session comparisons and is reported here solely
as a contextual indicator of overall session demand.
...
\textit{Frontiers in Neuroinformatics} 16 (2022): 861967,
https://doi.org/10.3389/fninf.2022.861967.

\bibitem{c2}
R. Khan, A. Naseer, M. Sajid, et al., ``Assessing Cognitive Load
Using EEG and Eye-Tracking in Immersive Environments,''
\textit{Multimodal Technologies and Interaction} 9, no. 9 (2025): 99,
https://doi.org/10.3390/mti9090099.

\bibitem{c3}
A. D. Blanco, M. Carrasco, and J. P. Lachaux, ``EEG Spectral Power
Correlates Across Cognitive Tasks With Theta-to-Alpha Ratio (TAR)
Significance,''
\textit{Journal of Neuroscience Methods} 410 (2025): 110292,
https://doi.org/10.1016/j.biopsycho.2025.109084.

\bibitem{c4}
S. Chikhi, N. Matton, and S. Blanchet, ``EEG Power Spectral Measures
of Cognitive Workload: A Meta-Analysis,''
\textit{Psychophysiology} 59, no. 6 (2022): e14009,
https://doi.org/10.1111/psyp.14009.

\bibitem{c5}
M. Pu\v{s}ica, A. Stikic, and B. Filipovic, ``Machine Learning
Performance in EEG-Based Mental Workload Estimation and Frontal
Midline Theta Activity,''
\textit{Frontiers in Neuroergonomics} 5 (2025): 135678,
https://doi.org/10.3389/fnrgo.2025.1621309.

\bibitem{c6}
M. Mondellini and S. Caggiula, ``A Multimodal Approach Exploiting EEG
to Investigate Mental Workload,''
\textit{International Journal of Human--Computer Studies} 181 (2024):
103180,
...
\textit{Brain Sciences} 13, no. 9 (2023): 1234,
https://doi.org/10.5220/0011628300003414.

\bibitem{c8}
E. Khan, F. Baig, and R. Hussain, ``Theta Activity and Cognitive
Functioning: Task-Related Increases in Frontal Theta During Cognitive
Demand,''
\textit{Cognitive Neuroscience} 15, no. 1 (2024): 45--58,
https://doi.org/10.1016/j.dcn.2024.101404.

\bibitem{c9}
J. Wu, Y. Zhang, and H. Li, ``Brain Functional Connectivity Changes
Induced by Cognitive Tasks Including Stroop,''
\textit{Scientific Reports} 15 (2025): 4567,
https://doi.org/10.1038/s41598-025-08330-6.

\bibitem{c10}
A. Arana-De-Las Casas, C. Flores, and R. Torres, ``Real-Time Mental
Workload Measurement for Cognitive Tasks Using an EEG-Based Workload
Index,'' \textit{bioRxiv} (preprint), 2024,
https://doi.org/10.21203/rs.3.rs-4442355/v1.

\bibitem{14}
A. Serrano-Barroso, M. Siugzdaite, J. Guerrero-Lebrero, et al.,
``Detecting Attention Levels in ADHD Children With a Video Game,''
\textit{Sensors} 21, no. 9 (2021): 3221,
https://doi.org/10.3390/s21093221.

\bibitem{15}
H. Ji, Y. Wang, and M. Chen, ``The Effects of Exergaming on Attention
in Children With ADHD,''
\textit{JMIR Serious Games} 11 (2023): e40438,
https://doi.org/10.2196/40438.

\bibitem{16}
B. Tleubayev, A. Sandygulova, and A. Niyetkaliyev,
``Robot-Assisted Therapy for Children With ADHD and ASD,''
in \textit{Proceedings of the ACM International Conference on
Pervasive Systems (ICPS)}, 2019, pp. 58--62,
https://doi.org/10.1145/3325693.3325703.

\bibitem{22}
O. A. Dominguez-Ramirez and V. Parra-Vega, ``Active Haptic Exploration
of Deformable Objects,''
\textit{DAAAM International Scientific Book},
2006, pp. 177--190.
...
Review,''
\textit{Annals of Surgery} 281, no. 6 (2025): 942--951,
...
Cognitive Control,''
\textit{Trends in Cognitive Sciences} 18, no. 8 (2014): 414--421,
...
\textit{Brain Research Reviews} 53, no. 1 (2007): 63--88,
...
\textit{Sensors} 23, no. 3 (2023): 1367,
...
Analysis,''
\textit{Frontiers in Neuroinformatics} 9 (2015): 16,
https://doi.org/10.3389/fninf.2015.00016.

\bibitem{DiFlumeri2018_RealDrivingMWL}
G. Di Flumeri, G. Borghini, P. Arico, et al.,
...
\textit{Frontiers in Human Neuroscience} 12 (2018): 509,
...
\textit{Sensors} 19, no. 6 (2019): 1324,
